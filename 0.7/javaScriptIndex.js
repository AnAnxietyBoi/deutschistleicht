...
[["habe gebacken"], ["habe befohlen"], ["habe begonnen"], ["habe gebissen"], ["habe gebogen"], ["habe geboten"], ["habe gebunden"], ["habe gebeten"], ["bin geblieben"], ["habe gebraten"], ["habe gebrochen"], ["habe gebrannt"], ["habe gebracht"], ["habe gedacht"], ["bin gedrungen"], ["habe gedurft"], ["habe empfohlen"], ["habe gegessen"], ["habe/bin gefahren", "habe gefahren", "bin gefahren"], ["bin gefallen"], ["habe gefangen"], ["habe gefunden"], ["bin geflogen"], ["bin geflohen"], ["ist geflossen"], ["habe gefressen"], ["habe gefroren"], ["habe geboren"], ["habe gegeben"], ["ist gediehen"], ["bin gegangen"], ["ist gelungen"], ["habe gegolten"], ["habe genossen"], [" ist geschehen"], ["habe gewonnen"], ["habe gegossen"], ["habe geglichen"], ["bin geglitten"], ["habe gegraben"], ["habe gegriffen"], ["habe gehabt"], ["habe gehalten"], ["habe gehangen"], ["habe gehoben"], ["habe geheißen"], ["habe geholfen"], ["habe gekannt"], ["hat geklungen"], ["bin gekommen"], ["habe gekonnt"], ["bin gekrochen"], ["habe geladen"], ["habe gelassen"], ["bin gelaufen"], ["habe gelitten"], ["habe geliehen"], ["habe gelesen"], ["habe gelegen"], ["habe gelogen"], ["habe gemieden"], ["habe gemocht"], ["habe gemusst"], ["habe genommen"], ["habe genannt"], ["habe gepfiffen"], ["ist gequollen"], ["habe geraten"], ["habe gerieben"], ["habe gerissen"], ["habe/bin geritten", "habe geritten", "bin geritten"], ["bin gerannt"], ["habe gerochen"], ["habe gerufen"], ["habe geschaffen"], ["habe geschieden"], ["habe geschienen"], ["habe geschoben"], ["habe geschossen"], ["habe geschlafen"], ["habe geschlagen"], ["bin geschlichen"], ["habe geschliffen"], ["habe geschlossen"], ["habe geschnitten"], ["bin erschrocken"], ["habe geschrieben"], ["habe geschrien"], ["bin geschritten"], ["habe geschwiegen"], ["bin geschwommen"], ["bin geschwunden"], ["habe geschworen"], ["habe gesehen"], ["bin gewesen"], ["habe gesandt"], ["habe gesungen"], ["bin gesunken"], ["habe gesessen"], ["habe gesollt"], ["habe gespalten"], ["habe gesprochen"], ["bin gesprungen"], ["habe gestochen"], ["habe gestanden"], ["habe gestohlen"], ["bin gestiegen"], ["bin gestorben"], ["habe gestunken"], ["habe gestoßen"], ["habe gestritten"], ["habe getragen"], ["habe getroffen"], ["habe getrieben"], ["habe/bin getreten", "habe getreten", "bin getreten"], ["habe getrunken"], ["habe getrogen"], ["habe getan"], ["habe verdorben"], ["habe vergessen"], ["habe verloren"], ["habe verziehen"], ["bin gewachsen"], ["habe gewaschen"], ["habe gewiesen"], ["habe gewandt"], ["habe geworben"], ["bin geworden"], ["habe geworfen"], ["habe gewogen"], ["habe gewusst"], ["habe gewollt"], ["habe/bin gezogen", "habe gezogen", "bin gezogen"], ["habe gezwungen"]]
]
...
var imenaStolpcev = ["Slovenski prevod", "Infinitiv", "3. Person", "Präteritum", "Perfekt"];
		...
		case 0:
			...
			for (var o = 0; o <= 4; o++)
			{
				...
				if (fff[o] == 1)
				{
					...
					{
						var kprejsni = vsiGlagoli[o][p].indexOf(odgovor) - 1 //preveri ce se odgovor ujema z kaksnim izmed nem glagolov
						if (kprejsni > k)
						{
					...
					else //NAROBE
					{
						...
						napacniGlagoli[o].push(vsiGlagoli[o][i][0]); //doda glagol ki je bil napačen glede na stolpec
						...
						document.getElementById("napacniGlagoli" + o).innerHTML = imenaStolpcev[o] + ": " + napacniGlagoli[o]; //izpis
						...
						if (document.getElementById("input" + o).value != "") //če ni odgovor prazen
						{
							...
							for (var z = 0; z <= vsiGlagoli[o][i].length - 1; z++) //za vsako besedo v arrayu glagola
							{
								...
								{
									var nemGlagolCrka = vsiGlagoli[o][i][z].charAt(u);
						...
						document.getElementById("pravilniGlagol" + o).innerHTML = "Pravilni glagol: " + "<span>" + vsiGlagoli[o][i][0] + "</span>";
					}
				}
				procentiPravilnih(o);
			}
